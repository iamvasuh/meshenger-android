...
public class Contact implements Serializable {
    ...
    static class CustomChatServer implements ConnectionData {
        ...
        public List<String> ice_servers;

        CustomChatServer(String chat_server, List<String> ice_servers) {
        ...
        public JSONObject toJsonObject() throws JSONException {
            ...
            for (String server : this.ice_servers) {
                array.put(server);
            }
    ...
    public static Contact importJSON(String contact) throws JSONException {
        ...
        for (int i = 0; i < data_array.length(); i += 1) {
            ...
            if (type.equals("Hostname")) {
                ...
                JSONArray array = item.getJSONArray("ice_servers");
                List<String> ice_servers = new ArrayList<String>();
                for (int j = 0; j < array.length(); j += 1) {
                    ice_servers.add(array.getString(j));
                }
